...
public class TagDTO {
	...
	public String toString() {
		return "TagDTO [book_id=" + book_id + ", book_name=" + book_name + ", genre_poet=" + genre_poet
				+ ", genre_essay=" + genre_essay + ", genre_selfDev=" + genre_selfDev + ", genre_history="
				+ genre_history + ", genre_science=" + genre_science + ", genre_novel=" + genre_novel
				+ ", genre_comics=" + genre_comics + ", genre_art=" + genre_art + "]";
	}
